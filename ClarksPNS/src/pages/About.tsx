...
export default function About () {
  return (
    <main className='w-full overflow-x-clip'>
            ...
            <div className='container mx-auto px-6 md:px-10 py-16 md:py-24 text-white'>
              <div className='max-w-3xl'>
                ...
                <p className='mt-4 text-white/90 text-base md:text-lg'>
                  What began as one store in Westwood, Kentucky has grown into a
                  regional network serving communities across Kentucky, Ohio,
                  and West Virginia—still run by the Clark family.
                </p>
        ...
        <div className='container mx-auto px-6 md:px-10 grid lg:grid-cols-12 gap-10'>
          <div className='lg:col-span-7'>
            ...
            <div className='prose prose-neutral max-w-none mt-4 text-black/80'>
              <p>
                Clark&apos;s Pump-N-Shop, Inc. was established in 1976 by John
                W. Clark with one convenience store in his hometown of Westwood,
                KY.
              </p>
              <p>
                In the 1990s, the company—by then at 18 locations—was purchased
                by John’s three sons: Rick, Rodney, and Brent Clark. The
                footprint expanded through group acquisitions in central
              ...
              <p>
                As a family-owned business, we take great pride in delivering
                clean, well-lit, fully stocked stores—and an experience that
          ...
          <div className='lg:col-span-5'>
            <div className='rounded-2xl border border-black/10 bg-brand/5 p-6'>
                ...
                {FOUNDERS.map(p => (
                  <li key={p.name} className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      {p.title && (
                        <p className='text-sm text-black/60'>{p.title}</p>
                      )}
                    </div>
                  </li>
                ))}
              ...
              <p className='mt-4 text-sm text-black/70'>
                John W. Clark also founded John W. Clark Oil Company, J&amp;R
                Diesel Repair, John W. Clark Transport, and John W. Clark
                Maintenance.
              </p>
            </div>
          </div>
      ...
      <section
        id='careers'
        className='relative py-16 md:py-24 bg-gradient-to-r from-brand/90 to-brand text-white'
      >
        ...
        <div className='container mx-auto px-6 md:px-10 grid lg:grid-cols-12 gap-10 items-center'>
          ...
          <div className='lg:col-span-7'>
            ...
            <p className='mt-3 text-white/90 max-w-prose'>
              Join a people-first team with local roots and room to grow—whether
              you’re serving guests in store, keeping operations running, or
              leading a district.
            </p>
          ...
          {/* <div className='lg:col-span-5'>
            <div className='rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 p-6'>
              ...
              <ul className='mt-3 grid gap-2 text-sm'>
                <li>
                  <a className='hover:underline' href='/manager-login'>
                    Manager Log In
                  </a>
                </li>
                <li>
                  <a className='hover:underline' href='/keep-it-clean-login'>
                    Keep It Clean Log In
                  </a>
                </li>
                <li>
                  <a className='hover:underline' href='/in-house-charge'>
                    In-House Charge
                  </a>
                </li>
                <li>
                  <a className='hover:underline' href='/download-application'>
      ...
      <section id='community' className='py-14 md:py-20 bg-white'>
        <div className='container mx-auto px-6 md:px-10'>
          <div className='max-w-3xl'>
            ...
            <p className='mt-2 text-black/70'>
              We’re proud to support the neighborhoods we serve—on the road and
              beyond the pump.
            </p>
          </div>
