...
const PerkCard = ({
  ...
  <article className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
    <h3 className="font-['Oswald'] text-xl md:text-2xl font-bold text-black">{title}</h3>
    <div className="prose prose-neutral mt-2 max-w-none text-black/80">{children}</div>
  </article>
);
        ...
        <div className="container mx-auto grid md:grid-cols-12 gap-8 px-6 md:px-10 py-14 md:py-16 items-center relative z-10">
          <div className="md:col-span-8">
            ...
            <p className="mt-3 text-white/90 max-w-prose">
              ...
              of a community. We take pride in friendly service, honest work, and
              supporting the neighborhoods we call home. Ready to grow with us?
            </p>
          ...
          <div className="md:col-span-4 md:flex md:justify-end">
            <div className="rounded-2xl overflow-hidden border border-white/20 bg-white/10 shadow-sm p-3">
              <div className="h-56 w-56 md:h-64 md:w-64 rounded-xl overflow-hidden grid place-items-center">
