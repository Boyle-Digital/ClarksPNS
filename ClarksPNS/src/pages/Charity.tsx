  ...
  return (
    <main id='donations' className='flex flex-col -mt-[16px]'>
              ...
              <div className='lg:col-span-7 p-6 md:p-8'>
                ...
                <div className='prose prose-neutral mt-3 max-w-none text-black/80'>
                  <p>
                    ...
                    was created in partnership with Ashland Community &
                    Technical College for local high‑school seniors.
                  </p>
                  <p>
                    In addition to accepting general donations, we host an
                    annual memorial golf outing — now also at Keene Trace Golf
                    Club: Champions Course — with proceeds supporting our
                    endowment.
                  </p>
                </div>
              </div>
      ...
      <section id='scholarship' className='py-12 md:py-16 bg-white'>
        <div className='container mx-auto px-6 md:px-10'>
          ...
          <div className='max-w-3xl'>
            ...
            <div className='mt-3 text-black/70'>
              <p>
                A $2,000 annual scholarship ($1,000/semester) awarded to
                students who show academic promise and plan to attend a 2–4 year
                college or university, trade school, or vocational school.
                Winners are eligible to renew annually for up to eight
                semesters.
              </p>
              <p className='mt-2'>
                <strong>2024 recipients:</strong> Alayna Reynolds (West Carter
                HS) and Madilyn Smith (South Point HS).
              </p>
            </div>
            <div className='mt-5 flex flex-wrap gap-3'>
              <a
      ...
      <section id='donate' className='py-16 bg-white border-y border-black/10'>
        <div className='container mx-auto px-6 md:px-10'>
          {/* Flex row so the divider spans full height */}
            ...
            <div className='lg:w-1/2 lg:pr-10 py-8'>
              <div className='h-full flex flex-col justify-center text-center lg:text-left'>
                ...
                <p className='mt-4 text-black/70'>
                  If you’d like to make a tax-deductible donation by mail,
            ...
            <div className='lg:w-1/2 lg:pl-10 py-8'>
              <div className='h-full flex flex-col justify-center text-center lg:text-left'>
                ...
                <p className='mt-4 text-black/70'>
                  ...
                  contact our team via the site contact form or your local
                  Clark’s Pump-N-Shop.
                </p>
                <div className='mt-6'>
                  <a
